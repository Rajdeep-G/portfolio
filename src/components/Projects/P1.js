                ...
                <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center  ">
                    <Fade left>
                        <div class="lg:max-w-lg lg:w-full md:w-1/3 w-5/6 mb-10 md:mb-0  ">
                            <img class="shadow-2xl object-cover object-center rounded" alt="project-1" src={process.env.PUBLIC_URL + "/Assets/projects/1.PNG"} />
                        </div>
                    </Fade>
                    ...
                    <div class="lg:flex-grow md:w-1/2 lg:pl-32 mt-8 md:mt-0 md:pl-64 flex flex-col md:items-start md:text-left items-center text-center">
                        <div class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-800">
                            Cf bot (for Discord)
                            </div>
