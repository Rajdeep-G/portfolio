            ...
            <header class="text-gray-100 body-font bg-indigo-500">
                <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center  ">
                    <nav class="flex lg:w-2/5 flex-wrap items-center text-bold md:ml-auto  ">
                        ...
                        <a class="hover:text-gray-900 text-2xl">Blogs</a>
                    </nav>
                    <ScrollLink to="Hero" spy={true} smooth={true} duration={500} class=" cursor-pointer  hover:text-gray-900 flex text-3xl order-first lg:order-none lg:w-1/5 title-font items-center text-gray-100 lg:items-center lg:justify-center mb-4 md:mb-0">


                        <img src={process.env.PUBLIC_URL + "/Assets/R2.png"} class="w-8 h-8 mt-3 rounded-full" />
                        <span class="ml-3 text-4xl">Home</span>
                    </ScrollLink>
                    <div class="   lg:w-2/5 inline-flex lg:justify-end ml-5 lg:ml-0">
                        <a href={process.env.PUBLIC_URL + '/Assets/cv.pdf'} download className="">
                            <button class="inline-flex items-center text-blue-900 text-xl bg-gray-100 border-0 py-1 px-3 focus:outline-none hover:bg-indigo-900 hover:text-gray-100 rounded mt-4 md:mt-0">
                                Resume
